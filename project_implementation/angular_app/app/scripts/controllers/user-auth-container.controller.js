...
.controller('UserAuthContainer', ['$scope', function($scope) {
	this.components = [
		'HTML5 Boilerplate',
		'AngularJS',
		'Karma'
...
.directive('sbUserAuthContainer', ['$translate', 'userAuthService', function($translate, userAuthService) {
	 ...
	 * scope: isolated scope to $scope.userAuthContainer only
